        ...
        <div className="pt-24">
          <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
            <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
              <p className="text-white uppercase tracking-loose w-full">Got Products You Wanna Sell?</p>
              <h1 className="text-white my-4 text-5xl font-bold leading-tight">
               Sell Your NFTs Here!
              </h1>
              <p className="text-white leading-normal text-2xl mb-8">
                Anyone can buy and sell clothing with NFTs
              </p>
